...
TODO:
1. Выучить теорию!!!
2. В проекте Calc написать такой же калькулятор, только с использованием конструкции switch;
3. Пользователь вводит число с клавиатуры, а программа должна сказать, является ли данное число палиндромом.
